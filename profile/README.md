...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Avelentis/.github/main/profile/logo-branco.svg">
...
| | |
| :-- | :-- |
| 🖥️ **Websites** | Institucionais e informativos, com painel de administração para a equipa atualizar os conteúdos. |
| 🧩 **Plataformas web** | Contas de utilizador, áreas reservadas e base de dados, quando um website simples não é suficiente. |
| 🎛️ **Painéis de administração** | Uma área privada para gerir textos, horários, avisos e registos, simples para quem não é técnico. |
| 🔌 **Integrações** | Ligação a pagamentos, correio eletrónico e outras aplicações já em uso. |
| ☁️ **Alojamento** | Publicação online, domínio, alojamento e cópias de segurança. |
| 🩺 **Manutenção** | Correção de falhas, atualizações e alterações depois da publicação. |
